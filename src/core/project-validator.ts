...
export function validateProject(projectInput: Project & { draft?: import("../schemas/worldbook-draft.js").WorldbookDraftEntry[]; characterCardConfig?: import("../schemas/character-card.js").CharacterCardConfig; mvuConfig?: import("../schemas/mvu.js").MvuConfig; htmlBeautifyConfig?: import("../schemas/html-beautify.js").HtmlBeautifyConfig; ejsConfig?: import("../schemas/ejs.js").EjsConfig }, options: { scope?: ProjectValidationScope; build?: { manifest?: BuildManifest; stale?: boolean; stale_reasons?: string[] }; export_target?: "worldbook" | "character_card" | "both" } = {}): ProjectValidationReport {
...
function validateRegexSection(project: Project): ValidationSection { return sectionFromIssues([], { enabled: project.kind.assets.regex.enabled, active_slice_count: project.kind.assets.regex.slice_count, script_count: 0, sources: project.kind.assets.regex.sources }); }
