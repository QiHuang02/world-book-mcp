...
export { MVU_INITVAR_TAG, MVU_OUTPUT_FORMAT_TAG, MVU_UPDATE_RULES_TAG, MVU_VARIABLE_LIST_TAG } from "./mvu-entry-templates.js";
...
export interface MvuAssets { regexScripts: RegexScriptAsset[]; tavernHelperScripts: TavernHelperScriptAsset[] }
...
export function buildMvuAssets(mvu: MvuConfig): MvuAssets {
  return { regexScripts: buildRegexScripts(mvu), tavernHelperScripts: [tavernScript("MVU", DEFAULT_MVU_BUNDLE, DEFAULT_MVU_BUTTONS), tavernScript("变量结构", mvu.schemaScript ?? "", [])] };
}
