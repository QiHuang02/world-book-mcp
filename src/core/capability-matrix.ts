...
const MATRIX: Record<WorldbookTaskClass, Omit<CapabilityMatrixEntry, "decision_hint">> = {
  original_character_card: {
    ...
    status: "partial",
    primary_tools: ["create_worldbuilding_outline", "submit_worldbuilding_summary", "plan_worldbook_entries", "draft_worldbook_entries", "validate_worldbook_draft", "create_character_card_template", "submit_character_card_config", "validate_greetings", "validate_character_card_config", "generate_character_card_json"],
    ...
    recommended_workflow: ["classify_worldbook_task", "create_worldbuilding_outline", "submit_worldbuilding_summary", "create_worldbook_entry_plan", "draft_worldbook_entries", "validate_worldbook_draft", "create_character_card_template", "submit_character_card_config", "validate_greetings", "create_final_review_report", "generate_character_card_json"],
  },
  derivative_extraction: {
    task_type: "derivative_extraction",
    purpose: "二创提取：接收 AI 整理后的原始素材/搜索摘要，形成结构化提取结果并转世界书/角色卡。",
    status: "partial",
    primary_tools: ["ingest_text_source", "ingest_web_research", "create_extraction_outline", "submit_extraction_result", "plan_worldbook_entries", "draft_worldbook_entries", "validate_worldbook_draft"],
    optional_tools: ["generate_worldbook_json", "create_character_card_template", "generate_character_card_json"],
    ...
    recommended_workflow: ["ingest_text_source", "create_derivative_extraction_template", "submit_derivative_extraction_outline", "validate_derivative_extraction_outline", "submit_extraction_result", "create_worldbook_entry_plan", "draft_worldbook_entries", "create_final_review_report"],
  },
  worldbuilding_only: {
    task_type: "worldbuilding_only",
    purpose: "纯世界观设计与世界书：从概念设计到条目化导出。",
    status: "partial",
    primary_tools: ["create_worldbuilding_outline", "submit_worldbuilding_summary", "validate_worldbuilding_summary", "submit_extraction_result", "plan_worldbook_entries", "draft_worldbook_entries", "validate_worldbook_draft", "generate_worldbook_json"],
    ...
    recommended_workflow: ["create_worldbuilding_design_template", "validate_worldbuilding_design", "classify_worldbook_card_type", "create_worldbook_entry_plan", "draft_worldbook_entries", "validate_worldbook_draft", "generate_worldbook_json"],
  },
  item_ability_equipment: {
    task_type: "item_ability_equipment",
    purpose: "物品/能力/装备条目：按类型生成与校验世界书条目。",
    status: "partial",
    primary_tools: ["get_entry_template", "draft_worldbook_entries", "validate_worldbook_draft"],
    optional_tools: ["update_worldbook_draft_entries", "generate_worldbook_json"],
    missing_or_planned: ["validate_item_entry"],
    recommended_workflow: ["get_entry_template", "validate_item_entry", "draft_worldbook_entries", "validate_worldbook_draft"],
  },
  style_extraction: {
    ...
    optional_tools: ["draft_worldbook_entries", "validate_worldbook_draft"],
